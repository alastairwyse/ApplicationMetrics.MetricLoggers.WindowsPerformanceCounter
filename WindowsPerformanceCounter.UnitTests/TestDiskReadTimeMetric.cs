...
namespace ApplicationMetrics.MetricLoggers.WindowsPerformanceCounter.UnitTests
{
    ...
    /// </summary>
    class TestDiskReadTimeMetric : IntervalMetric
    {
        public TestDiskReadTimeMetric()
        {
            base.name = "DiskReadTime";
            base.description = "Represents the amount of time taken to perform a read operation from disk.";
        }
    }
}
